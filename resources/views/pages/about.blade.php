                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-12">
                        <div class="about-img mb-50">
                            ...
                            <div class="about-img__style-shape wow fadeInUp2 animated" data-wow-delay='.4s'>
                                <img src="{{asset('assets/img/shape/07.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-6 col-md-12">
                        <div class="about__wrapper about__wrap__03 pl-65 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            ...
                            <p>Since our inception, we have worked tirelessly to create safe, inclusive, and empowering environments where individuals and communities can thrive. Our interventions are guided by a deep commitment to humanity, fairness, and long-term impact. We do not merely provide aid — we build pathways to resilience, independence, and sustainable development.</p>
